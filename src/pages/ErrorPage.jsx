...
function ErrorPage() {
  return (
    <>
      <div
        className={cn(
          'animate-hue-rotate absolute top-0 left-0 m-0 h-full w-full overflow-hidden',
          'bg-radial-[circle_at_0%_100%] from-[#240015] to-[#12000b]'
        )}
      ></div>
      <svg
        id='svgWrap_2'
        ...
        viewBox='0 0 700 250'
        className={cn(
          'absolute top-1/2 left-1/2 h-auto w-[600px] max-w-full',
          'animate-hue-rotate -translate-x-1/2 -translate-y-1/2'
        )}
      >
        <g>
          <path
      ...
      <h2
        className={cn(
          'absolute top-1/2 left-1/2 mt-[150px] block text-3xl font-light text-[#12000b] uppercase text-shadow-[0px_0px_4px_black]',
          'textFadeIn -translate-x-1/2 -translate-y-1/2'
        )}
      >
        Page Not Found
      </h2>
